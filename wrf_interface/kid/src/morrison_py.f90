...
subroutine mphys_morrison_interface_2d(t2d,p2d,dz2d_wrf,qc2d,qv2d,qr2d,qi2d,&
     ...
     nr_stend2d, ns_stend2d, ng_stend2d)
  use MODULE_MP_MORR_TWO_MOMENT2, only: morr_two_moment_micro2
  ...
  real,intent(out) :: qc_tend2d(nz1,nx1), qi_tend2d(nz1,nx1), qni_tend2d(nz1,nx1), & 
       ...
       nr_stend2d(nz1,nx1), ns_stend2d(nz1,nx1), ng_stend2d(nz1,nx1) 
...
!print*, nz, nz1, nx, nx1
  ...
  do i=1,nx1
     ...
     call morr_two_moment_micro2(qc_tend1d(1:nz1), qi_tend1d(1:nz1), qni_tend1d(1:nz1), &
