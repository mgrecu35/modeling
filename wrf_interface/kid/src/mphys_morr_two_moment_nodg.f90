...
contains
  ...
  Subroutine mphys_morrison_interface2
    ...
    do i=1,nx
       ...
       call morr_two_moment_micro2(qc_tend1d, qi_tend1d, qni_tend1d, &
  ...
  end Subroutine mphys_morrison_interface2

end module mphys_morr_two_moment2
