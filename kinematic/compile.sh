...
cpp -DDEF_NZ=120 -DDEF_NX=126 src/parameters.f90 > src/parameters_cpp.f90
...
gfortran -c -fPIC -g -ffpe-trap=invalid,zero,overflow -O2 -fcheck=all -finit-real=nan src/module_mp_morr_two_moment_nodg.f90
...
f2py -c -m kinDriver src/morrison_py.f90 libmorisson.so --f90flags="-fcheck=all -fPIC -g -ffpe-trap=invalid,zero,overflow -O2 -finit-real=nan" 
